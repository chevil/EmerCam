...
public class DESEncrypt {
   ...
   public DESEncrypt( String key) {
     try {
      ...
      Log.e( Constants.TAG, "could not create cipher classes", e );
    }
   }
   ...
   public String encrypt(String input) {
     try {
      ...
      Log.e( Constants.TAG, "could not encrypt data", e );
      return "";
    }
   }
   ...
   public String decrypt(String input) {
     try {
      ...
      Log.e( Constants.TAG, "could not decrypt data", e );
      return "";
    }
   }

   public byte[] decrypt(byte[] edata) {
     try {
      Cipher cipher = Cipher.getInstance("DES");// cipher is not thread safe
      cipher.init(Cipher.DECRYPT_MODE, mKey);
